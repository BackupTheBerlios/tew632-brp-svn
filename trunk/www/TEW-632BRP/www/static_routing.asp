...
<title>TRENDNET | TEW-632BRP | Routing | Static</title>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function loadsetting()
	{
		...
		if ((temp_wan_poto == "pptp")||(temp_wan_poto == "pppoe"))
		{
			if((temp_wan_pptp_russia_enable == "1")||(temp_wan_pppoe_russia_enable == "1"))
			{
