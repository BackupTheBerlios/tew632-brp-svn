...
<title>TRENDNET | TEW-632BRP | Main | WAN</title>
...
<SCRIPT LANGUAGE="JavaScript">
	function loadSettings(){
		...
		if(dat[0] !="0.0.0.0" && get_by_id("wan_pptp_ipaddr").value == "0.0.0.0"){
			get_by_id("wan_pptp_ipaddr").value = dat[0];
		}
		if(dat[1] !="0.0.0.0" && get_by_id("wan_pptp_netmask").value == "0.0.0.0"){
			get_by_id("wan_pptp_netmask").value = dat[1];
		}
		...
		set_checked("<% CmoGetCfg("support_pptp_mppe"); %>",get_by_id("pptp_mppe"));
		disable_static_address_PPTP_Russia_PPTP(get_by_name("wan_pptp_dynamic"), get_by_id("wan_pptp_ipaddr"), get_by_id("wan_pptp_netmask"), get_by_id("wan_pptp_gateway"), get_by_id("wan_primary_dns"));
		check_connectmode();
	}
	...
	function send_request(){
		...
		if (!check_pwd("wan_pptp_password", "pwd2")){
			return false;
		}
    	...
    	get_by_id("asp_temp_60").value = "rus_pptp";
		
		
		if(get_by_id("pptp_mppe").checked == false){
			get_by_id("support_pptp_mppe").value = 0;
		}else{
			get_by_id("support_pptp_mppe").value = 1;
		}
            ...
            <tr>
              ...
              <td height="400" valign="top" background="bg3.gif">
                   ...
                   <form id="form1" name="form1" method="post" action="apply.cgi">
                  	...
                  	<input type="hidden" id="wan_proto" name="wan_proto" value="pptp">
                     ...
                     <tr>
                       ...
                       <td class="bggrey">
					      <select size="1" id="conn_type" name="conn_type" onChange="change_wan_html(this.selectedIndex)">
                           ...
                           <option value="6" selected>Russia PPTP</option>
                         </select>
                           <br>
                           <br>
                           <input type="radio" value="1" name="wan_pptp_dynamic" onClick='disable_static_address_PPTP_Russia_PPTP(get_by_name("wan_pptp_dynamic"), get_by_id("wan_pptp_ipaddr"), get_by_id("wan_pptp_netmask"), get_by_id("wan_pptp_gateway"), get_by_id("wan_primary_dns"))'><b>Dynamic IP</b>&nbsp;&nbsp;&nbsp;
                           <input type="radio" value="0" name="wan_pptp_dynamic" onClick='disable_static_address_PPTP_Russia_PPTP(get_by_name("wan_pptp_dynamic"), get_by_id("wan_pptp_ipaddr"), get_by_id("wan_pptp_netmask"), get_by_id("wan_pptp_gateway"), get_by_id("wan_primary_dns"))'><b>Static IP</b>
                       </td>
                     </tr>
                   </table>
                   <table width="100%" height="301" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                     <tr>
                       <td align="right" class="bgblue">IP
                         Address</td>
                       <td bgcolor="#FFFFFF" class="bggrey"><input type=text id="wan_pptp_ipaddr" name="wan_pptp_ipaddr"  size="16" maxlength="15" value="<% CmoGetCfg("wan_pptp_ipaddr","none"); %>"></td>
                     </tr>
                     <tr>
                       <td align="right" class="bgblue">Subnet
                         Mask</td>
                       <td bgcolor="#FFFFFF" class="bggrey"><input type=text id="wan_pptp_netmask" name="wan_pptp_netmask" size="16" maxlength="15" value="<% CmoGetCfg("wan_pptp_netmask","none"); %>"></td>
                     </tr>
                     <tr>
                       <td align="right" class="bgblue">Gateway</td>
                       <td bgcolor="#FFFFFF" class="bggrey"><input name="wan_pptp_gateway" type=text id="wan_pptp_gateway" size="16" maxlength="15" value="<% CmoGetCfg("wan_pptp_gateway","none"); %>"></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                       <td align="right" class="bgblue">Server
                         IP \ Name</td>
                       <td bgcolor="#FFFFFF" class="bggrey"><input type=text id="wan_pptp_server_ip" name="wan_pptp_server_ip" size=30 maxlength=63 value="<% CmoGetCfg("wan_pptp_server_ip","none"); %>"></td>
                     </tr>
                     <tr>
                       <td align="right" class="bgblue">PPTP
                         Account</td>
                       <td bgcolor="#FFFFFF" class="bggrey"><input type=text id="wan_pptp_username" name="wan_pptp_username" size="30" maxlength="63" value="<% CmoGetCfg("wan_pptp_username","none"); %>"></td>
                     </tr>
                     <tr>
                       <td align="right" class="bgblue">PPTP
                         Password</td>
                       <td bgcolor="#FFFFFF" class="bggrey"><input type=password id="wan_pptp_password"  name="wan_pptp_password" size="30" maxlength="63" value="WDB8WvbXdHtZyM8Ms2RENgHlacJghQyG"></td>
                     </tr>
                     <tr>
                       <td align="right" class="bgblue">PPTP
                         Retype password</td>
                     ...
                     <tr>
                       ...
                       <td bgcolor="#FFFFFF" class="bggrey">
                         <input type=text id="wan_pptp_max_idle_time" name="wan_pptp_max_idle_time" size="4" maxlength="4" value="<% CmoGetCfg("wan_pptp_max_idle_time","none"); %>">
                         Minutes</td>
                     </tr>
                     <tr>
                      <td align="right" class="bgblue">MTU </td>
                      <td bgcolor="#FFFFFF" class="bggrey"><input type=text id="wan_pptp_mtu" name="wan_pptp_mtu" maxlength="4" size="4" value="<% CmoGetCfg("wan_pptp_mtu","none"); %>"></td>
                    </tr>
					<tr>
                      <td align="right" class="bgblue">MPPE Enable </td>
                      <td bgcolor="#FFFFFF" class="bggrey">
					    <input name="pptp_mppe" type=checkbox id="pptp_mppe" value="1">
						<input type="hidden" id="support_pptp_mppe" name="support_pptp_mppe" value="<% CmoGetCfg("support_pptp_mppe","none"); %>">
                        (Only for MSCHAPv2)</td>
                    </tr>
                     <tr>
                       <td align="right" class="bgblue">&nbsp;</td>
                       <td bgcolor="#FFFFFF" class="bggrey2">
                       	<input type="button" id="cancel" name="cancel" value="Cancel" onClick="window.location='wan_pptp.asp'">
