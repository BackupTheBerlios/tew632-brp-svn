...
<SCRIPT LANGUAGE="JavaScript">
	...
	function send_request(){
   		...
   		get_by_id("asp_temp_16").value = "1"; //Russia pptp dynamic ip
		get_by_id("asp_temp_48").value = "1"; //Russia pptp enable
          ...
          <tr>
            ...
            <td width="86%" align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <form name="form1" id="form1" method="post" action="apply.cgi">
          		...
          		<input type="hidden" id="html_response_return_page" name="html_response_return_page" value="wizard_russia2.asp">
          		<input type="hidden" id="reboot_type" name="reboot_type" value="none">
				<input type="hidden" id="asp_temp_48" name="asp_temp_48" value="<% CmoGetCfg("asp_temp_48"); %>">
	  			<input type="hidden" id="asp_temp_16" name="asp_temp_16" value="<% CmoGetCfg("asp_temp_16"); %>">
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                <tr>
                  ...
                  <input type="text" id="asp_temp_17" name="asp_temp_17" size="30" maxlength="63" value="<% CmoGetCfg("asp_temp_17","none"); %>">
</font></td>
                </tr>
                <tr>
                  ...
                  <input type="password" id="asp_temp_182" name="asp_temp_18" size="30" maxlength="63" value="WDB8WvbXdHtZyM8Ms2RENgHlacJghQyG">
</font></td>
                </tr>
              </table>
               <br><br><br><br><br><br>
