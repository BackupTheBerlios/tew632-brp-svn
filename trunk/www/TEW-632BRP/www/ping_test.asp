...
<title>TRENDNET | TEW-632BRP | Tools | Ping Test</title>
          ...
          <td width="20%" valign="top"><table width="56%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="2" class="submenubg">
                  ...
                  <tr>
                    <td align="right"><font color="#FFFFFF">&bull;</font></td>
                    <td><a href="ping_test.asp" class="submenus"><b><u>Ping Test</u></b></a></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="400" valign="top" background="bg3.gif">
                  <table width="100%" border="0" cellpadding="3" cellspacing="0">
                    <tr>
                      <td width="85%" class="headerbg">Ping Test </td>
                      <td width="15%" class="headerbg"><a href="help_tools.asp#tools_ping_test" target="_blank"><img src="but_help1_0.gif" width="69" height="28" border="0" id="Image8" onMouseOver="MM_swapImage('Image8','','but_help1_1.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
                    </tr>
                  </table>
				 <form id="form1" name="form1" method="post" action="ping_response.cgi">
					<input type="hidden" id="html_response_page" name="html_response_page" value="ping_back.asp">
                    <input type="hidden" id="html_response_message" name="html_response_message" value="The setting is saved.">
                    <input type="hidden" id="html_response_return_page" name="html_response_return_page" value="ping_test.asp">
                  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                    <tr>
                      <td nowrap class="bgblue">Host Name or IP address:</td>
                      <td class="bggrey">
                        <input type="text" id="ping_ipaddr" name="ping_ipaddr" size="30" maxlength="63" value="<% CmoGetStatus("ping_ipaddr"); %>">
                        <input type="submit" value="Ping" name="ping" onClick="return check_ip();"></td>
                    </tr>
                  </table>
                  <p>&nbsp;</p>
				  </form>                <p>&nbsp;</p></td>
