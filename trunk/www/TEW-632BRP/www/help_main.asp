...
the screen.</P>
      <P> <SPAN STYLE="font-weight : bold;">Host Name:</SPAN><A NAME="lan&amp;dhcp_server_hostname"></A> Type the <A HREF="glossary.asp#def_host_name">host name</A> in the
        ...
        The default host name is &quot;TEW-632BRP&quot;</P>
...
set the <A HREF="glossary.asp#def_MTU">MTU</A>.</P>
      ...
      <P><strong>Bigpond Cable:</strong> BigPond is Australia's largest Internet Service Provider and is Telstra's brand name for consumer broadband services. <br>
            <p><A HREF="help_main.asp">back to top</A></p>
      <p>&nbsp;</p>
      <p>&nbsp;
      </p>
...
realtime clock, select your time zone, specify an <A HREF="glossary.asp#def_NTP">NTP</A> server, and enable or disable daylight saving.</P>
      ...
      <P> <SPAN STYLE="font-weight : bold;">Synchronize the clock with:</SPAN><A NAME="Synchronize_the_clock_with:"></A>Select the clock adjustment method form the drop-down list.
				Automatic: Automatically adjust the system time from NTP Server.Manual: Manually adjust the system time when you press the Set Time button.
			</P>  
      <P> <A HREF="help_main.asp">back to top</A></P>
      <P>&nbsp;</P>
      <P>&nbsp;  </P>
