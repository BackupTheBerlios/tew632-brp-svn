...
<title>TRENDNET | TEW-632BRP | Tools | Firmware</title>
<link rel="stylesheet" href="style.css" type="text/css">
<SCRIPT language=JavaScript src="public_msg.js"></SCRIPT>
<SCRIPT language=JavaScript src="public.js"></SCRIPT>
<SCRIPT language=JavaScript>
	var submit_button_flag = 0;
	function check_upgrade_firmware(){
          ...
          <td width="20%" valign="top"><table width="56%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="2" class="submenubg">
                  ...
                  <tr>
                    <td align="right"><font color="#FFFFFF">&bull;</font></td>
                    <td><a href="firmware.asp" class="submenus"><b><u>Firmware</u></b></a></td>
                  </tr>
                  <tr>
                    <td align="right"><font color="#FFFFFF">&bull;</font></td>
            ...
            <tr>
              ...
              <td height="400" valign="top" background="bg3.gif">
                  <table width="100%" border="0" cellpadding="3" cellspacing="0">
                    <tr>
                      <td width="85%" class="headerbg">Firmware</td>
                      <td width="15%" class="headerbg"><a href="help_tools.asp#tools_firmware" target="_blank"><img src="but_help1_0.gif" width="69" height="28" border="0" id="Image8" onMouseOver="MM_swapImage('Image8','','but_help1_1.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
                    </tr>
                  </table>
				  <form id="form1" name="form1" method="post" action="firmware_upgrade.cgi" enctype="multipart/form-data">
				  	...
				  	<input type="hidden" name="html_response_return_page" value="firmware.asp">
                    <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                      <tr>
                        <td align="right" nowrap class="bgblue">Upgrade Firmware</td>
                        <td class="bggrey"><input type="file" id="file" name="file"></td>
                      </tr>
                      <tr>
                        <td class="bgblue">&nbsp;</td>
                        <td class="bggrey2"><input type="button" value="Upgrade" name="upgrade" onClick="check_upgrade_firmware()"></td>
                      </tr>
                    </table>
				    <br>
                </form></td>
