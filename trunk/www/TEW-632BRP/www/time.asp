...
<title>TRENDNET | TEW-632BRP | Main | Time</title>
...
<SCRIPT LANGUAGE="JavaScript">
	function loadSettings(is_true){
		...
		get_by_id("time_zone").selectedIndex = get_by_id("asp_temp_55").value;
	...
	function send_request(is_true){
		...
		get_by_id("asp_temp_55").value = document.getElementById("time_zone").selectedIndex;
