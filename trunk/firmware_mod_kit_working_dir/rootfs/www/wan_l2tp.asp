        ...
        <tr>
          ...
          <td width="78%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td height="400" background="bg3.gif">
                   <table width="100%" border="0" cellpadding="3" cellspacing="0">
                     <tr>
                       <td width="85%" class="headerbg">WAN</td>
                       <td width="15%" class="headerbg"><a href="help_main.asp#main_wan" target="_blank"><img src="but_help1_0.gif" width="69" height="28" border="0" id="Image81" onMouseOver="MM_swapImage('Image81','','but_help1_1.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
                     </tr>
                   </table>
                    ...
                    <tr>
                      ...
                      <td colspan="3" class="bggrey">
                        <select size="1" id="conn_type" name="conn_type" onChange="change_wan_html(this.selectedIndex)">
                          ...
                          <option value="3" selected>L2TP</option>
                          <option value="4">BigPond Cable</option>
                          <option value="5">Russia PPPoE</option>
                          <option value="6">Russia PPTP</option>
                        </select>                       <br>
                      <br>
                      <input type="radio" value="1" name="wan_l2tp_dynamic" onClick='disable_static_address(get_by_name("wan_l2tp_dynamic"), get_by_id("wan_l2tp_ipaddr"), get_by_id("wan_l2tp_netmask"), get_by_id("wan_l2tp_gateway"), get_by_id("wan_primary_dns"))'><b>Dynamic IP</b>&nbsp;&nbsp;&nbsp; 
                      <input type="radio" value="0" name="wan_l2tp_dynamic" onClick='disable_static_address(get_by_name("wan_l2tp_dynamic"), get_by_id("wan_l2tp_ipaddr"), get_by_id("wan_l2tp_netmask"), get_by_id("wan_l2tp_gateway"), get_by_id("wan_primary_dns"))'><b>Static IP</b></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF" class="bggrey2">
                      	<input type="button" id="cancel" name="cancel" value="Cancel" onClick="window.location='wan_l2tp.asp'">
