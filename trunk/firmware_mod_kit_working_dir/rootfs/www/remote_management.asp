...
<title>TRENDNET | TEW-632BRP | Management | Remote Management</title>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function loadSettings(){				
		...
		set_checked("<% CmoGetCfg("ipsec_pass_through","none"); %>", get_by_name("ipsec_pass_through"));
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
                  ...
                  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                    <tr>
                      ...
                      <td class="bggrey"><font face="Arial" size="2">
                        ...
                        </font><font face="Arial" size="2">Enable</font>
                    ...
                    <tr>
                      ...
                      <td class="bggrey"><font face="Arial" size="2">
                        ...
                        </font><font face="Arial" size="2">Enable</font><font face="Arial" size="2">
    ...
    Disabled </td>
                    ...
                    <tr>
                      <td align="right" valign="top" class="bgblue">IPSec </td>
                      <td height="23" class="bggrey">
                        <input type="radio" value="1" name="ipsec_pass_through">
                        Enabled
                        <input type="radio" value="0" name="ipsec_pass_through">
                        Disabled</td>
                    </tr>
                    <tr>
