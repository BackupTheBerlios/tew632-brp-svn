...
and set the channel for wireless communications.</P>
      ...
      <P> <strong>SSID Broadcast: </strong>Select Disabled if you would not like the SSID of your wireless network to be broadcasted by the TEW-632BRP. If this option is Disabled, the SSID of the TEW-632BRP will not be seen by Site Survey utilities so your wireless clients will have to know the SSID of your TEW-632BRP in order to connect to it. </P>      <P> <A HREF="help_wlan.asp">back to top</A></P>
      <P>&nbsp;</P>
      <P>&nbsp;      </P>
      <table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
