...
network interconnection topology.</P>
      ...
      <P> <SPAN STYLE="font-weight : bold;">Interface:</SPAN><A NAME="routing_table_interface"></A> Displays whether the node is connected via a <A HREF="glossary.asp#def_WAN">WAN</A> or <A HREF="glossary.asp#def_LAN">LAN</A>.</P>
