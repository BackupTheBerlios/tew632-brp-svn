                     ...
                     <tr>
                       ...
                       <td class="bggrey">
					      <select size="1" id="conn_type" name="conn_type" onChange="change_wan_html(this.selectedIndex)">
                           ...
                           <br>
                           <br>
                           <input type="radio" value="1" name="wan_pptp_dynamic" onClick='disable_static_address(get_by_name("wan_pptp_dynamic"), get_by_id("wan_pptp_ipaddr"), get_by_id("wan_pptp_netmask"), get_by_id("wan_pptp_gateway"), get_by_id("wan_primary_dns"))'><b>Dynamic IP</b>&nbsp;&nbsp;&nbsp;
                           <input type="radio" value="0" name="wan_pptp_dynamic" onClick='disable_static_address(get_by_name("wan_pptp_dynamic"), get_by_id("wan_pptp_ipaddr"), get_by_id("wan_pptp_netmask"), get_by_id("wan_pptp_gateway"), get_by_id("wan_primary_dns"))'><b>Static IP</b>
                       </td>
                     </tr>
                   </table>
