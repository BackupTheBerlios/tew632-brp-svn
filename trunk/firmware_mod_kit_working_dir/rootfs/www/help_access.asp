...
define access for special applications such as games, and set <A HREF="glossary.asp#def_firewall">firewall</A> rules.</P>
      ...
      <UL>
        <LI CLASS="mvd-P">
          <P> <SPAN STYLE="font-weight : bold;">Disable:</SPAN> the function of MAC
            filter be dsiable, in the <A HREF="#access_usergroup_user_table">MAC Table</A> are allowed Internet access.</P>
        <LI CLASS="mvd-P">
          <P> <SPAN STYLE="font-weight : bold;">Enable:</SPAN> All users are allowed
            Internet access except those user in the <A HREF="#access_usergroup_user_table">MAC
              Table</A> are deny Internet access and limited browser own Router.</P>
      </UL>
