...
<title>TRENDNET | TEW-632BRP | Wireless | Basic</title>
            ...
            <tr>
              ...
              <td height="400" valign="top" background="bg3.gif">
                      <table width="100%" border="0" cellpadding="3" cellspacing="0">
                        <tr>
                          <td width="85%" class="headerbg">Basic</td>
                          <td width="15%" class="headerbg"><a href="help_wlan.asp#wireless_basic" target="_blank"><img src="but_help1_0.gif" width="69" height="28" border="0" id="Image8" onMouseOver="MM_swapImage('Image8','','but_help1_1.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
                        </tr>
                      </table>
                    ...
                    <input type="hidden" id="reboot_type" name="reboot_type" value="wireless">
                      ...
                      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                        ...
                        <tr>
                          ...
                          <td bgcolor="#FFFFFF" class="bggrey"><input name="show_ssid" type="text" id="show_ssid" size="20" maxlength="32" value=""></td>
                        </tr>
                        <tr>
                          <td align="right" class="bgblue"><font face="Arial">Channel </font></td>
                          <td bgcolor="#FFFFFF" class="bggrey"><font face="Arial" size="2">
                            <select size="1" id="wlan0_channel" name="wlan0_channel"></select>
                            (Domain:
                            <script>
                      ...
                      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                        ...
                        <tr id="show_channel_width">
                          ...
                          <td class="bggrey">
                              ...
                              <input type="hidden" id="wlan0_11n_protection" name="wlan0_11n_protection" value="<% CmoGetCfg("wlan0_11n_protection","none"); %>">                          </td>
                        </tr>
                        
                        <tr>
                          <td align="right" class="bgblue"><font face="Arial"> SSID Broadcast </font></td>
                          <td bgcolor="#FFFFFF" class="bggrey"><font face="Arial" size="2"> </font><font face=verdana size=2><b>
                          <font face=verdana size=2><b>
                          <input type="radio" name="wlan0_ssid_broadcast" value="1">
                          </b></font> </b></font><font size="2">Enabled </font><font face=verdana size=2><b>
                          <input type="radio" name="wlan0_ssid_broadcast" value="0">
                          </b></font><font size="2">Disabled</font></td>
                        </tr>
						<tr>
                          <td align="right" class="bgblue"><font face="Arial"> WMM </font></td>
                          <td bgcolor="#FFFFFF" class="bggrey"><font face="Arial" size="2"> </font><font face=verdana size=2><b>
                            <input type="radio" name="wlan0_wmm_enable" value="1">
                            </b></font><font size="2">Enabled </font><font face=verdana size=2><b>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#FFFFFF" class="bggrey2">
                          	<input type="button" id="cancel" name="cancel" value="Cancel" onClick="window.location='wireless_basic.asp'">
