...
<title>TRENDNET | TEW-632BRP | Advanced Setting</title>
                        ...
                        <tr id="setting_wep" style="display:none">
                          <td colspan="2" width="100%">
                              ...
                              <tr bgcolor="#CCCCCC">
                                ...
                                <td width="70%" class="bggrey">
                                	<input type="radio" value="1" name="wlan0_wep_default_key">                    
                              ...
                              <tr bgcolor="#CCCCCC">
                                ...
                                <td width="70%" class="bggrey">
                                	<input type="radio" value="2" name="wlan0_wep_default_key">                    
                              ...
                              <tr bgcolor="#CCCCCC">
                                ...
                                <td width="70%" class="bggrey">
                                	<input type="radio" value="3" name="wlan0_wep_default_key">                    
                              ...
                              <tr bgcolor="#CCCCCC">
                                ...
                                <td width="70%" class="bggrey">
                                	<input type="radio" value="4" name="wlan0_wep_default_key">                    
